...
export const metadata: Metadata = {
  title: "FitBooker - Gym Scheduling & Payment App for Fitness Professionals",
  description: "Streamline your fitness business with FitBooker's all-in-one scheduling and payment platform. Perfect for gyms, studios, and personal trainers. Start free trial today.",
  keywords: "gym scheduling app, fitness booking system, gym payment processing, personal trainer app, fitness business software",
  metadataBase: new URL("https://fitbooker.com"),
  alternates: {
    canonical: "https://fitbooker.com"
  },
  openGraph: {
    title: "FitBooker - Transform Your Fitness Business",
    description: "The scheduling and payment platform designed for gyms and trainers. Manage bookings, process payments, and grow your business effortlessly.",
    siteName: "FitBooker",
    type: "website",
    images: [
      {
        url: "https://images.pexels.com/photos/3912977/pexels-photo-3912977.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "FitBooker app interface showing scheduling and payment features"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "FitBooker - Gym Scheduling & Payment App",
    description: "Streamline your fitness business with our all-in-one scheduling and payment platform. Start your free trial today.",
    images: ["https://images.pexels.com/photos/3912977/pexels-photo-3912977.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
